    ...
    return (
        <div className="payment__actions">
            <Formik
                ...
                onSubmit={ () => {} }
            >
                <Form id="payment" className="payment__form">
                    <label htmlFor="select-address" className="payment__label">
                        <span className="payment__input-title">Ждём вас в кофейне по адресу</span>
                        <Field
                            as="select"
                            id="select-address"
                            name="address"
                            ...
                            <option value="Ул. 50 лет Октября, 14">Ул. 50 лет Октября, 14</option>
                            <option value="Ул. 50 лет Октября, 14">Ул. 50 лет Октября, 14</option>
                            <option value="Ул. 50 лет Октября, 14">Ул. 50 лет Октября, 14</option>
                        </Field>
                    </label>
